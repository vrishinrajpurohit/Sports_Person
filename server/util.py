...
def get_cv2_image_from_base64_string(b64str):
    # Ensure base64 string has a comma, indicating the prefix is included
    if ',' in b64str:
        encoded_data = b64str.split(',')[1]
    else:
        encoded_data = b64str  # If no prefix, treat the whole string as the base64 data

    # Decode and convert to a NumPy array
